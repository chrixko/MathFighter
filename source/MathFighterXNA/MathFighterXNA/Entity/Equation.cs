...
namespace MathFighterXNA.Entity {
    ...
    public class Equation : BaseEntity {
        ...
        public Equation(int product, Player solver) {
            ...
            //FirstSlot = new NumberSlot(solver, (MainGame.Width / 2) - 64, (MainGame.Height / 2) + 100, true);
            //SecondSlot = new NumberSlot(solver, (MainGame.Width / 2) + 32, (MainGame.Height / 2) + 100, true);
        }
